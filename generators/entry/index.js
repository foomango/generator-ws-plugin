...
module.exports = class extends Generator {
  async prompting() {
    const prompts = [
      {
        type: 'input',
        name: 'entryName',
        message: 'Your entry name: ',
        validate: str => (str.length > 0 ? true : 'Entry name is required.'),
      },
      {
        type: 'input',
        name: 'featureName',
    ...
    if (this.answers.entryName) {
      this.answers.entryCamelName = toCamelName(this.answers.entryName)
    }
